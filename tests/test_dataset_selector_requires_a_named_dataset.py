"""Require the resolver to refuse an unnamed dataset.

A silent active-dataset default once made five variation renders read the central campaign.
"""
...
def test_resolving_with_no_dataset_named_raises_and_lists_the_valid_keys() -> None:
    """Require the refusal to list valid dataset keys."""
    try:
