#!/usr/bin/env python3
"""Check the HF_PT2 canonical-candidate override selector.
...
def main() -> int:
    ...
    # The main selector has no default because a variation can otherwise read the central campaign.
    # The legacy-regression diagnostic remains available by name.
