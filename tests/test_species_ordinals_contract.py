...
def test_artifact_is_the_ratified_table() -> None:
    ...
    Pinned as literals on purpose. The count and digest are what every earlier
    handoff cites, and deriving them from the artifact under test would make
    this test agree with whatever the artifact happened to say.
    """
    payload = artifact()
