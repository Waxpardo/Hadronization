...
PLOTTER = ROOT / "PlottingScripts/improvedPlotting_THnSparse.C"
BOUNDARY_UTILS = ROOT / "PlottingScripts/MultiplicityBoundaryUtils.h"
BOUNDARY_PLOTTER = (
    ROOT
    / "PlottingScripts/Plot_MultiplicityDistribution_PercentileBoundaries.C"
)
RUNNER = ROOT / "PlottingScripts/run_paper_plots.sh"
