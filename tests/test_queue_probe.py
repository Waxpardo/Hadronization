#!/usr/bin/env python3
"""Require an unavailable queue to report UNKNOWN, never EMPTY.

An SSH outage can make condor_q fail with no rows.
Treating that result as zero jobs could advance a checkout while work remains.
