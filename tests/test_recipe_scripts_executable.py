#!/usr/bin/env python3
"""Require every directly invoked Golden Output script to be executable.

Four scripts once lacked executable bits, causing recipes R6, R7, and R10 to exit 126.

The mode bit is a property of the file that
