#!/usr/bin/env python3
"""Require compare_subset_parent.py to rediscover its known anchor failure.

The committed anchor against the MONASH parent flags 30 bins at scale about ten.
The flagged set concentrates in baryons and includes Sigma_b-bar-minus.
...
def main() -> int:
    ...
    # The 2.2x block-to-central sigma inflation does not describe this case.
    # It would predict that the two largest bins survive near z=5.
    # That value is the block-to-central
