    ...
    with tempfile.TemporaryDirectory() as temp:
        ...
        run_root(
            ...
            (
                ...
                # Dense-spectrum contract (owner ruling 2026-08-18): the DRAWN
                # curves carry marker 1 and the tune's real marker survives only
                # on the legend proxy. The superseded literal here read
                # "monash_line=1 junctions_line=2 closepacking_line=7", which had
                # itself gone stale when the styling mandate made every tune
                # solid -- it was a printed constant, not a measured one.
