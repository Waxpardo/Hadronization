...
# The closure gate requires the campaign schema and has no default.
# A schema derived from the data could validate the wrong campaign contract.
# Resolve the value before starting the approximately eleven-hour merge.
...
# Resolve the tag now because the wrapper runs only after all merges.
...
# The full check digests 3,000 inputs and measured 12 hours 42 minutes.
# Missing or malformed evidence runs the validator again.
