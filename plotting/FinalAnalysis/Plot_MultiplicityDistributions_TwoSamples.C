...
//
// Usage:
//   root -l -b -q 'plotting/FinalAnalysis/Plot_MultiplicityDistributions_TwoSamples.C'
//
//   root -l -b -q \
//     'plotting/FinalAnalysis/Plot_MultiplicityDistributions_TwoSamples.C("12-01-2026","27-03-2026",10,true)'
//
