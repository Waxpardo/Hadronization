...
// This legacy diagnostic uses five broad percentile classes.
...
// Keep one colour for each legacy percentile class.
        ...
        int nSub                  = 10)
{
    ...
    // Produce eight tune, sector, and species plots:
    ...
    // ---------- Draw ----------
    // Draw the eight configured plots.
