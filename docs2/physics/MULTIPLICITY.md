...
`plotting/improvedPlotting_THnSparse.C:2000-2002`; histogram `summed MULTIPLICITY` at `:2002`). Absolute `N_ch` thresholds
...
a receipt literal at `plotting/improvedPlotting_THnSparse.C:1993-1995`).
...
(`plotting/improvedPlotting_THnSparse.C:1996-1998`).
...
`plotting/improvedPlotting_THnSparse.C:1993-1995` and the PR-13 merge commit at
`:2003-2004` — and nothing compares the two copies. Treat the JSON strings as
