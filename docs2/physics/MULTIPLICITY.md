...
`plotting/improvedPlotting_THnSparse.C:1955-1957`; histogram `summed MULTIPLICITY` at `:1957`). Absolute `N_ch` thresholds
...
a receipt literal at `plotting/improvedPlotting_THnSparse.C:1948-1950`).
...
(`plotting/improvedPlotting_THnSparse.C:1951-1953`).
