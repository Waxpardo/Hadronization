...
(`plotting/improvedPlotting_THnSparse.C:3260-3261`, `:3276-3277`).
...
(`plotting/improvedPlotting_THnSparse.C:3271-3275`). A zero denominator returns `NaN` with a warning rather than a
silent division (`plotting/improvedPlotting_THnSparse.C:3262-3266`).
...
(`plotting/improvedPlotting_THnSparse.C:3283-3285`). The owner ruling of 2026-08-21
