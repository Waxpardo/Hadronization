...
| G2 | MONASH charm angular correlations, 2×2 pads | the hard-coded canvas of V-CORRELATIONS (`plotting/improvedPlotting_THnSparse.C:4915-4917`) | `CHARMCorrelations_MONASH` |
...
(`plotting/improvedPlotting_THnSparse.C:1363-1365`). Every balancing
...
`SetPlotPointOrThrow` (`plotting/improvedPlotting_THnSparse.C:3564`) aborts the
