...
| G2 | MONASH charm angular correlations, 2×2 pads | the hard-coded canvas of V-CORRELATIONS (`plotting/improvedPlotting_THnSparse.C:4831-4833`) | `CHARMCorrelations_MONASH` |
...
(`plotting/improvedPlotting_THnSparse.C:1362-1364`). Every balancing
...
`SetPlotPointOrThrow` (`plotting/improvedPlotting_THnSparse.C:3480`) aborts the
