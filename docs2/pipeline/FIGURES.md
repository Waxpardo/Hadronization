...
| G2 | MONASH charm angular correlations, 2×2 pads | the hard-coded canvas of V-CORRELATIONS (`plotting/improvedPlotting_THnSparse.C:5181`) | `CHARMCorrelations_MONASH` |
...
| G9 | kinematic spectra, ten species × {pT, η, φ} | target `kinematic-spectra` (`plotting/Plot_InclusiveKinematicSpectra_Raw.C:2196-2233`) | `Inclusive_pT_<species>_shape`, `Inclusive_eta_<species>_shape`, `Inclusive_phi_<species>_shape` |
...
(`plotting/improvedPlotting_THnSparse.C:1365-1367`). Every balancing
...
`SetPlotPointOrThrow` (`plotting/improvedPlotting_THnSparse.C:3760`) aborts the
