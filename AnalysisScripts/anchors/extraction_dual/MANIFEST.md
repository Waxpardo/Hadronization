...
>
> *Deflated 2026-08-13 (`ERROR_RECORD.md` **E6**, ÷5.03 for E5 replication):
...
> (`docs/SIGMA_B_ORDERING_AND_ADJUDICATION.md` §2b, `docs/ERROR_RECORD.md` E4).
>
...
`HANDOFF_20260810_v40_GENERATIONAL.md` §6 says *"exact on four directories — all
