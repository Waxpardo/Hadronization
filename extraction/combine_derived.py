...
def combined_systematic(nominal_value: float, per_campaign: dict) -> dict:
    ...
    recomputed from that campaign's own render. Everything that cancels inside
    the quantity has already cancelled before this function sees it.
