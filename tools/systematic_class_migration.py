...
generator: 0.767 % (ValidationReports/NCH_DECAY_POLICY_BIAS_8317.md -- dN_ch/deta
...
# ValidationReports/NCH_DECAY_POLICY_BIAS_8317.md, recomputed from the two
...
# The 8.315 pair, kept so the supersession is visible in the source that depends
# on it. NCH_CALIBRATION_20260730.md; gave a bias of 1.327 % and a margin of only
# 1.16 against c11's edge.
...
def main() -> int:
    ...
    print(f"  superseded 8.315 value was {100 * superseded_8315_bias():.4f} % "
          f"-- see ValidationReports/NCH_DECAY_POLICY_BIAS_8317.md")
