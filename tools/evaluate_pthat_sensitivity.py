...
def compare_observable(
    ...
    if lower > margin or upper < -margin:
        ...
        # The project specification requires a scientific decision whenever
        # a shift is resolved beyond pilot precision.  Equivalence margins
        # are useful precision targets, but are not owner authorization to
        # accept a nonzero pTHat dependence.
