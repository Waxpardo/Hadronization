...
# One healthy-looking outlier used 2,398 CPU-seconds before blocking on I/O.
# Measured normal maxima were 321, 632, and 762 CPU-seconds across the tunes.
# A low threshold could preferentially discard slow, baryon-rich junction events.
