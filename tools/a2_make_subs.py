...
def main() -> int:
    ...
    ap.add_argument("--base", type=pathlib.Path,
                    default=pathlib.Path("/data/alice/ipardoza"))
    ap.add_argument("--source-sub", type=pathlib.Path,
                    default=pathlib.Path("/data/alice/ipardoza/Hadronization/"
                                         "submit_HF_RUN3_V1_analysis.sub"))
