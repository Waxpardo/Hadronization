...
def build_extremes(base: dict, percentiles: list[float]) -> dict:
    ...
    document["_comment_variant"] = (
        ...
        "order, not from comparing percentile magnitudes. GENERATED; do not "
        "hand-edit.")
    return document
...
def build_baryonmeson(base: dict, percentiles: list[float]) -> dict:
    ...
    document["_comment_variant"] = (
        ...
        "FOUR REGISTERED ASSOCIATES ONLY -- Sigma channels deferred by "
        "recorded decision; beauty is buildable from the freeze today and "
        "charm is trigger-blocked, see docs/FIGURE_INVENTORY.md 3.3b. PROPOSAL "
        "awaiting physics sign-off, not a committed reference. GENERATED by "
