...
Answers the gap recorded in `HANDOFF_20260810_v40_GENERATIONAL.md` §2.3 / §6.3:
...
`decay_parent_map_v1.json` records **only** the dominant channel — the per-species
...
| map | `AnalysisScripts/decay_parent_map_v1.json`, `map_sha256 = e343fd8872f974…`, file sha256 `a67e8ae5f853689c010e991859242a77b913787dd30ab3d4c1b68bc05758c00c` |
