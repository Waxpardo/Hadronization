...
tool change during a live campaign and is governed by the private release-blocker register.
...
2. **Operationally:** a running CR job past **~1600 s CPU** is already wedged and
   ...
   the private post-submission record as basis. **No guard change now** — the current
