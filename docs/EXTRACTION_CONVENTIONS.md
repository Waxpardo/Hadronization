...
> is now quarantined for the baryon sector** (private error-ledger entry E4).
> **A superseding private convention-table record rebuilds all of them from the merged
...
| **experiment-comparable** | the observable it *feeds* | F4's historical defective decay map, chained to the terminal heavy descendant | "how much compensation would a detector actually reconstruct, and as what?" |
