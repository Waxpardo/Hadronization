...
> `AnalysisScripts/anchors/extraction_dual/MANIFEST.md`, `docs/ERROR_RECORD.md`
...
> supersession both stand; see `docs/ERROR_RECORD.md` E4.)*
>
...
> `docs/ERROR_RECORD.md` **E6**: these counts are replicated-era extraction
