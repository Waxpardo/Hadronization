...
(`docs/ERROR_RECORD.md`, review finding A4). Without it the gate derived its
...
(`docs/ERROR_RECORD.md` E4). **Step 2 exists because of that**: aggregate
...
> section is unchanged and so is the quarantine** — see `ERROR_RECORD.md` E4 for
