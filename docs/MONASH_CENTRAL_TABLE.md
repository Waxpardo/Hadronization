...
> # ⚠ NOT FINAL — SUPERSEDED 2026-08-13 (`docs/ERROR_RECORD.md` E5)
>
...
> `docs/MERGED_CONVENTION_TABLES.md` for the corrected table.
>
...
> (beauty) into both the central and the blocks. `docs/ERROR_RECORD.md` E5.
>
...
> **√24.2 = 4.92**. `docs/ERROR_RECORD.md` **E6**;
...
`MERGED_CONVENTION_TABLES.md` (v47) computed the central from the merged output
