...
BB_MONASH_BASE="${BB_MONASH_BASE:-/data/alice/pveen/ProductionsPythia/BatchedOutput_bb_214/SAMPLING_MONASH_bb_214}"
BB_JUNCTIONS_BASE="${BB_JUNCTIONS_BASE:-/data/alice/pveen/ProductionsPythia/BatchedOutput_bb_JUNCTIONS_214/SAMPLING_MONASH_bb_JUNCTIONS_214}"
CC_MONASH_BASE="${CC_MONASH_BASE:-/data/alice/pveen/ProductionsPythia/BatchedOutput_cc_214/SAMPLING_MONASH_cc_214}"
CC_JUNCTIONS_BASE="${CC_JUNCTIONS_BASE:-/data/alice/pveen/ProductionsPythia/BatchedOutput_cc_JUNCTIONS_214/SAMPLING_MONASH_cc_JUNCTIONS_214}"
