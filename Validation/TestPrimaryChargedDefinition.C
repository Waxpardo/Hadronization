...
int TestPrimaryChargedDefinition(const char* mode = "monash",
  ...
  std::string card;
  if (modeName == "monash") {
    card = "SimulationScripts/pythiasettings_Hard_Low_ccbb_MONASH.cmnd";
  } else if (modeName == "junctions") {
    card = "SimulationScripts/pythiasettings_Hard_Low_ccbb_JUNCTIONS.cmnd";
  } else if (modeName == "closepacking") {
    card = "SimulationScripts/pythiasettings_Hard_Low_ccbb_CLOSEPACKING.cmnd";
  } else {
