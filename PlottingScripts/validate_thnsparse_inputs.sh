...
configuration="${1:-PlottingScripts/configuration_multiplicity_reduced_JUNCTIONS_THnSparse.json}"
report="${2:-PlottingScripts/validation/final_thnsparse_input_validation.json}"
...
root -l -b <<ROOTCMDS
.L PlottingScripts/Validate_THnSparse_Production.C+
