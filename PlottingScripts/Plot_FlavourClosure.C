...
// written by AnalysisScripts/status_analysis_THnSparse_qq.C.
//
...
//
// Usage:
//   root -l -b -q 'PlottingScripts/Plot_FlavourClosure.C("<dir>/DplusDminus.root","Dplus")'
...
int Plot_FlavourClosure(const char* pairFilePath, const char* triggerName,
                        const char* outputDir = "PlottingScripts/Plots/Closure") {
  gStyle->SetOptStat(0);
