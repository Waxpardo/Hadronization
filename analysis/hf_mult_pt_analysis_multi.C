...
//
// Usage:
//   root -l -b -q 'analysis/hf_mult_pt_analysis_multi.C+(10, "27-03-2026", "combined")'
//
...
//   root -l -b -q 'analysis/hf_mult_pt_analysis_multi.C+(10, "01-04-2026_100M", "combined")'
// or
//   root -l -b -q 'analysis/hf_mult_pt_analysis_multi.C+g'
                            ...
                            Long64_t& globalPionCountInTree)
  {
    ...
    for (Long64_t i = 0; i < nEntries; ++i, ++globalEventIndex) {
      ...
      for (std::size_t j = 0; j < nParts; ++j) {
        ...
        // ---------------- Charm ----------------
        // The legacy charm sample excludes Bc, which has HFCLASS 45.
