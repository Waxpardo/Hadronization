...
#
# Usage:
#   ./analysis/run_hf_analysis.sh OUTPUT_TAG [NSUB] [CHARGE_MODE]
#   ./analysis/run_hf_analysis.sh OUTPUT_TAG [CHARGE_MODE] [NSUB]
#
# Example:
#   ./analysis/run_hf_analysis.sh 27-03-2026
#   ./analysis/run_hf_analysis.sh 27-03-2026 20
#   ./analysis/run_hf_analysis.sh 27-03-2026 20 separate
...
root -l -b -q "analysis/hf_mult_pt_analysis_multi.C+(${NSUB}, \"${OUTPUT_TAG}\", \"${CHARGE_MODE}\")"
